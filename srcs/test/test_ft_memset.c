...
/*   Updated: 2021/12/27 03:38:06 by jodufour         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{3,
	...
	0x55, 2, 2},
{4,
	(uint8_t[]){0x74, 0x11, 0x30, 0x3a},
	(uint8_t[]){0x74, 0x11, 0x30, 0x3a},
	0x21, 4, 3},
{5,
	(uint8_t[]){0xd2, 0xf1, 0x88, 0x12, 0x00, 0xaf, 0x0e, 0xc3, 0xdd},
	(uint8_t[]){0xd2, 0xf1, 0x88, 0x12, 0x00, 0xaf, 0x0e, 0xc3, 0xdd},
	0xba, 9, 7},
{6,
...
int	test_ft_memset(int *const ret)
{
	...
	while (g_test[i].num)
	{
		addr0 = memset(g_test[i].addr0, g_test[i].c, g_test[i].n);
		addr1 = ft_memset(g_test[i].addr1, g_test[i].c, g_test[i].n);
		result(g_test[i].num,
			addr0 - g_test[i].addr0 == addr1 - g_test[i].addr1
